...
export function GET() {
  ...
  const lines = [
    ...
    '',
    '## Data sources',
    '- NMVTIS (National Motor Vehicle Title Information System), operated by the US Department of Justice: title history, title brands, salvage, odometer, theft and total-loss data.',
    ...
    '',
    '## About',
    `${SITE_NAME} is not affiliated with Carfax, AutoCheck or Experian. Reports are for informational purposes and are not a substitute for an in-person mechanical inspection.`,
    '',
  ];
