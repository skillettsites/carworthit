...
export default function sitemap(): MetadataRoute.Sitemap {
  const now = new Date();
  const routes = ['', '/how-it-works', '/pricing', '/sample-report', '/about', '/methodology', '/press', '/guides', '/blog', '/tools', '/fuel-cost-calculator', '/depreciation-calculator', '/terms', '/privacy', '/disclaimer'];
