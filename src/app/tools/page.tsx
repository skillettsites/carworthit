...
export const metadata: Metadata = {
  ...
  description: 'Free car tools: VIN decoder by make, title, lien, odometer and stolen vehicle checks, window sticker lookup, engine and transmission by VIN, car sales tax and out-the-door price calculators by state, used car negotiation calculator, dealer doc fee and registration fee tables, diminished value, fuel cost and depreciation calculators.',
