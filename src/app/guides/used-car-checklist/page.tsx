...
type Item = { text: string; why?: string; link?: { href: string; label: string } };
...
const SECTIONS: Section[] = [
  ...
  },
  {
    ...
    items: [
      ...
      {
        text: 'Decide your opening offer, your target and your walk-away price before you talk, and write them down. The car you are looking at is not the last car.',
        link: { href: '/negotiate-used-car-price', label: 'Use the free used car negotiation calculator to turn the asking price and what you found into those three numbers.' },
      },
    ],
  },
];
                  ...
                  <div>
                    ...
                    {i.link && (
                      <p className="mt-0.5 text-sm">
                        <Link href={i.link.href} className="font-medium text-brand underline-offset-2 hover:underline">{i.link.label}</Link>
                      </p>
                    )}
                  </div>
                </li>
